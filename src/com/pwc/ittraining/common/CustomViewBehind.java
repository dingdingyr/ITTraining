...
import com.pwc.ittraining.common.SlidingMenu.CanvasTransformer;

public class CustomViewBehind extends ViewGroup {

	private static final String TAG = "CustomViewBehind";

	private static final int MARGIN_THRESHOLD = 80; // dips
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mSecondaryContent != null){
			final int contentWidth2 = getChildMeasureSpec(widthMeasureSpec, 0, width-mSecondaryWidthOffset);
			mSecondaryContent.measure(contentWidth2, contentHeight);
		}
	}
